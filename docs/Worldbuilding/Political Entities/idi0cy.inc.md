...
idiocy.inc is a scientific institution and product manufacturer operating on the multiversal scale. They produce various products and perform research and operate within [Amirlithic](Amirlithic%20Union.md) [voidspace](../The%20Cosmos/Firmament%20Theory/index.md).
...
They sent an idea to the higher narrative plane to tell a friend of the writer (idi0cy) to tell the writer (the Narrator) to make them exist. Hence, idiocy.inc now exists.
