...
This section contains a list of all political entities on a cosmic scale. To view entities that are reality-specific, see the [Realities](../Realities/index.md) section.

<div class="grid cards" markdown>

-   __But before we begin, how do big societies like this work?__
...
-   __Point me to the nearest cluster of edgy religious weirdos.__
    ...
    [:octicons-arrow-right-24: Absolutionists](Absolutionists.md)

-   __Take me to the manager. The manager of the cosmos, of course.__
    ...
    [:octicons-arrow-right-24: Amirlithic Union](Amirlithic%20Union.md)

-   __I'm a creative person and want to meet people that can relate to my trauma.__
    ...
    [:octicons-arrow-right-24: Architects](Architects.md)

-   __Is there a Switzerland equivalent in the multiverse?__
    ...
    [:octicons-arrow-right-24: Arithine](Arithine.md)

-   __I need even edgier and even more religious weirdos.__
    ...
    [:octicons-arrow-right-24: Church of the Six Deities](Church%20of%20the%20Six%20Deities.md)

-   __Can we just have a normal civilization without gimmicks?__
    ...
    [:octicons-arrow-right-24: Criodun](Criodun.md)

-   __Is there really no cliché prophecy trope here?__
    ...
    [:octicons-arrow-right-24: Cult of the Aethein](Cult%20of%20the%20Aethein.md)

-   __I'm a nerd and want to connect with other nerds.__
    ...
    [:octicons-arrow-right-24: Daethai](Daethai.md)

-   __Are there really six immortals? Not four, or five?__
    ...
    [:octicons-arrow-right-24: Dominion of Chaos](Dominion%20of%20Chaos.md)

-   __I'm an edgelord and want to see DEATH and DESTRUCTION__
    ...
    [:octicons-arrow-right-24: Dysphorium](Dysphorium.md)

-   __Seven foot rats, rats along his rats. When he sees your rats it all fades to rats.__
    ...
    [:octicons-arrow-right-24: Haelborne](Haelborne.md)

-   __I hate mice! They're so disgusting and weird!__
    ...
    [:octicons-arrow-right-24: Heathborne](Heathborne.md)

-   __This story is too serious for me. I want some jokes.__
    ...
    [:octicons-arrow-right-24: idi0cy.inc](idi0cy.inc.md)

-   __I want violence and war. Glory to the empire! Manifest destiny!__
    ...
    [:octicons-arrow-right-24: Verion](Verion.md)
